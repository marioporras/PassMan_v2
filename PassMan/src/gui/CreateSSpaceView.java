...
public class CreateSSpaceView extends JFrame implements ActionListener  {
	...
	public CreateSSpaceView() {
		...
		lblNewLabel_1_1_2_1.setBounds(144, 321, 136, 25);
		...
		textField_5.setBounds(215, 346, 123, 21);
		...
		btnNo_1_1_1.setBounds(348, 343, 59, 25);
		...
		btnNo_1_1_2.setBounds(589, 48, 73, 25);
		...
		btnNo_1.setBounds(340, 400, 73, 25);
		panel.add(btnNo_1);
		...
		lblNewLabel.setIcon(new ImageIcon(CreateSSpaceView.class.getResource("/assets/Fondo_CreateSpaceView.PNG")));
		lblNewLabel.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		lblNewLabel.setDisplayedMnemonic(KeyEvent.VK_ENTER);
		lblNewLabel.setBounds(0, 0, 708, 360);
